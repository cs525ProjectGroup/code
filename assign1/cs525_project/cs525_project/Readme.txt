...
We implement several method in storage_mgr.c file. Our storage manager gets following functionalities: manipulating page files, reading blocks from disc and writing blocks to a page file. 

We use makefile for compilation management. We can simply type “make” to compile the whole program and use “make clean” to remove files with “.o” extension. After makefile manipulation, it generates an executable file named “test_assign1”. By running this file with “./test_assign1” command, we can get the test result that shows all test cases are passed.
